...
InitializeSetupWarning0=Warning: No bundled Syncthing zip file was found. Setup will prompt for a local zip file.
; Memo pages
...
ConfigPage0Item4=Cloud drive &address (optional):
...
ReadyMemoZipFileBundled=Bundled offline zip file (%1)
ReadyMemoInstallSettings=Installation settings:
ReadyMemoInstallOffline=Offline installation (use bundled or local installation zip file)
...
ReadyMemoConfigItem4Set=Cloud drive address is %1
ReadyMemoConfigItem4Empty=Cloud drive address is not set
...
BundledZipFound=Bundled offline zip file found: %1
BundledZipNotFound=Bundled offline zip file not found: %1
BundledZipNotValid=Bundled offline zip file is not valid: %1
